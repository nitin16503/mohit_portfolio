...
class Projects(models.Model):
    ...
    image_1 = models.ImageField(upload_to='static/project_images/')  # Define the image field
    image_2 = models.ImageField(upload_to='static/project_images/')  # Define the image field
